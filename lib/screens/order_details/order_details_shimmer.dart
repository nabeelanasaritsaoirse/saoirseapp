                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Row(
                                ...
                                spacing: 10.w,
                                children: [
                                  _box(width: 22.w, height: 22.w, radius: BorderRadius.circular(6.r)),
                                  _box(width: 30.w, height: 22.w, radius: BorderRadius.circular(6.r)),
                                  _box(width: 22.w, height: 22.w, radius: BorderRadius.circular(6.r)),
                                ],
                              ),
                            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      spacing: 10.w,
                      children: [
                        _box(width: 180.w, height: 35.h, radius: BorderRadius.circular(15.w)),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          spacing: 12.w,
                          children: [
                            _box(width: 100.w, height: 50.h, radius: BorderRadius.circular(5.r)),
                            _box(width: 100.w, height: 50.h, radius: BorderRadius.circular(5.r)),
                          ],
                        ),
                      ],
