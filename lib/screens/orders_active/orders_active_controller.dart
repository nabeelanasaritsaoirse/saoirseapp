...
class OrderActiveController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    fetchActiveOrderHistory();
    scrollController.addListener(() {
      if (scrollController.position.pixels >=
          scrollController.position.maxScrollExtent - 100) {
        fetchActiveOrderHistory(loadMore: true);
      }
    });
  }
  ...
  //---------FETCH ACTIVEORDER HISTORY----------------//

  Future<void> fetchActiveOrderHistory({bool loadMore = false}) async {
