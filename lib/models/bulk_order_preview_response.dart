...
class BulkOrderPreviewData {
  ...
  factory BulkOrderPreviewData.fromJson(Map<String, dynamic> json) {
    return BulkOrderPreviewData(
      ...
      items: (json['items'] as List).map((e) => PreviewItem.fromJson(e)).toList(),
...
class PreviewSummary {
  ...
  factory PreviewSummary.fromJson(Map<String, dynamic> json) {
    return PreviewSummary(
      ...
      totalFirstPayment: (json['totalFirstPayment'] ?? 0).toDouble(),
      totalProductPrice: (json['totalProductPrice'] ?? 0).toDouble(),
      totalOriginalPrice: (json['totalOriginalPrice'] ?? 0).toDouble(),
...
class PreviewInstallment {
  ...
  factory PreviewInstallment.fromJson(Map<String, dynamic> json) {
    return PreviewInstallment(
      ...
      firstPayment: (json['firstPayment'] ?? 0).toDouble(),
...
class PreviewPayment {
  ...
  factory PreviewPayment.fromJson(Map<String, dynamic> json) {
    return PreviewPayment(
      firstPaymentRequired: (json['firstPaymentRequired'] ?? 0).toDouble(),
      totalOrderValue: (json['totalOrderValue'] ?? 0).toDouble(),
      remainingAfterFirstPayment: (json['remainingAfterFirstPayment'] ?? 0).toDouble(),
    );
  }
}
