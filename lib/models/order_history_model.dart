class OrderHistoryResponse {
  ...
  factory OrderHistoryResponse.fromJson(Map<String, dynamic> json) {
    return OrderHistoryResponse(
      ...
      orders: (json["orders"] as List<dynamic>? ?? []).map((e) => OrderHistoryItem.fromJson(e)).toList(),
      count: json["count"] ?? 0,
    );
  }
}
...
class OrderHistoryItem {
  ...
  factory OrderHistoryItem.fromJson(Map<String, dynamic> json) {
    ...
    final variant = (product["variants"] as List?)?.isNotEmpty == true ? product["variants"][0] : {};
    ...
    return OrderHistoryItem(
      ...
      dailyPlan: "₹${payment["dailyAmount"] ?? 0}/${payment["totalDuration"] ?? 0} Days",
